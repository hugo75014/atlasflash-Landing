...
function FinalCta() {
  return (
    <section className="container-page pb-24 pt-12 sm:pb-32 sm:pt-16">
      <div className="relative overflow-hidden rounded-2xl border border-ink-200 bg-surface-2 text-ink-900">
        <div
          aria-hidden="true"
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute -top-24 left-1/2 h-72 w-[42rem] -translate-x-1/2 rounded-full bg-ink-900/5 blur-3xl"
        />
        <div className="relative px-6 py-16 text-center sm:px-10 sm:py-20" data-reveal>
          ...
          <p className="mx-auto mt-5 max-w-xl text-[15px] leading-[1.6] text-ink-600 sm:text-base" data-i18n="final.subtitle" suppressHydrationWarning>
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <a
              ...
              className="inline-flex h-11 items-center justify-center rounded-md border border-ink-200 bg-transparent px-5 text-[14px] font-medium text-ink-900 transition-colors hover:bg-ink-900/5"
             suppressHydrationWarning>
              Se connecter
            </a>
          </div>
