...
const fr: Record<string, string> = {
  ...
  "pricing.row.cli": "Outils CLI installés en un clic",
...
const en: Record<string, string> = {
  ...
  "pricing.row.cli": "CLI tools installed in one click",
...
const es: Record<string, string> = {
  ...
  "pricing.row.cli": "Herramientas CLI instaladas en un clic",
...
const pt: Record<string, string> = {
  ...
  "pricing.row.3.pro": "50",
  "pricing.row.3.unlimited": "ilimitado",
  "pricing.row.cli": "Ferramentas CLI instaladas em um clique",
...
const hi: Record<string, string> = {
  ...
  "pricing.row.cli": "एक क्लिक में इंस्टॉल हुए CLI टूल्स",
